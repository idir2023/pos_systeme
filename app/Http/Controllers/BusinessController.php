    ...
    */
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $business_details = $request->only(['name', 'start_date', 'currency_id', 'tax_label_1', 'tax_number_1',
                'tax_label_2', 'tax_number_2', 'default_profit_percent', 'default_sales_tax', 'default_sales_discount', 
                'sell_price_tax', 'sku_prefix',
                'time_zone', 'fy_start_month', 'accounting_method', 'transaction_edit_days',
                'sales_cmsn_agnt', 'item_addition_method', 'currency_symbol_placement', 'on_product_expiry',
            ...
            $checkboxes = ['enable_editing_product_from_purchase','facture',
                'enable_inline_tax','enable_brand', 'enable_category','enable_import','enable_import_stock',
                'update_product_price','print_labels','warranties','import_sales','discounts','shipments','add_draft',
                'list_drafts','add_quotation','list_quotations','enable_modal_pos','pay_term','invoice_scheme_id',
                'sell_document','pay_term_number','document_purchase','discount_percent_purchase','unit_cost_before_tax','unit_selling_price',
                'barcode_type','customer_groups','import_contacts','applicable_tax','selling_price_tax_type','enable_sub_category', 'enable_price_tax','enable_purchase_status',
                'enable_lot_number', 'enable_racks', 'enable_row', 'enable_position', 'enable_sub_units','active_avance'];
