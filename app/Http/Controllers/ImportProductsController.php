        ...
        try {
            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    //Add alert quantity
                     $product_array['alert_quantity'] = trim($value[6]);
                    ...
                    if ($product_array['type'] == 'single') {
                        ...
                        $product_array['variation']['profit_percent'] = $default_profit_percent;

                        //Calculate purchase price
                        $dpp_inc_tax = '';
                        $dpp_exc_tax = trim($value[4]);
                        ...
                        $selling_price = ! empty(trim($value[5])) ? trim($value[5]) : 0;
