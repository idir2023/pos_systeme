                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if (! empty($sub_category_name)) {
                     ...
                     if (! empty($sub_category_name)) {
                         ...
                         $sub_sub_category_name = trim($value[37]);
                         if (! empty($sub_sub_category_name)) {
                             $sub_sub_category = Category::firstOrCreate(
                                 ['business_id' => $business_id, 'name' => $sub_sub_category_name, 'category_type' => 'product'],
                                 ['created_by' => $user_id, 'parent_id' => $sub_category->id]
                             );
                             $product_array['sub_sub_category_id'] = $sub_sub_category->id;
                         }
                     }
