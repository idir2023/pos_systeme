...
@section('content')
    <div class="col-12 text-center align-items-center justify-content-center right-col-content" style="padding-top: 6%"><a href="#" class="image">
        <img class="logo-height" style="max-width:200px; height: auto;" src="https://manditechinfo.store/icon.webp"></a>
    </div>
    <div class="container-fluid" style="margin:0; padding:0; display:flex; justify-content:center; align-items: center;">
    <div class="login-form col-md-12 col-xs-12 d-flex justify-content-center align-items-center" style="max-width: 540px; width: 100%; box-shadow: 0 5px 20px rgba(173,181,189,.2); border-radius: 0.938rem; background-color: #fff!important; font-family: Poppins,Helvetica,sans-serif;">
        <!--<p class="form-header">@lang('lang_v1.login')</p>-->
        <h2 class="text-dark text-center mb-7" style="padding-bottom: 4%;">@lang('lang_v1.login')</h2>
        <form method="POST" action="{{ route('login') }}" id="login-form">
            {{ csrf_field() }}
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}" style="padding-bottom: 1%;">
                @php
                ...
                @endphp
                <label class="form-label">@lang('lang_v1.username') :<span style="color: red;">*</span></label>
            ...
            <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}" style="padding-bottom: 1%;">                
                <label class="form-label">@lang('lang_v1.password') :<span style="color: red;">*</span></label>
            ...
            <div class="form-group" style="padding-bottom: 2%;">
                <button type="submit" class="btn btn-warning btn-login btn-block" style="height: 40px;">@lang('lang_v1.login')</button>
                <!--@if(config('app.env') != 'demo')
