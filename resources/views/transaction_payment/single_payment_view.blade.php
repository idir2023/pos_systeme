        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    @if($single_payment_line->method == "cheque")
                    {{ $single_payment_line->cheque_type ?? '' }}<br>
                    @else
                    ...
                    <strong>@lang('messages.Cheque_Echeance') :</strong>
                    {{ $single_payment_line->cheque_echeance }}<br>
                    <strong>@lang('messages.cheque_status') :</strong>
                    {{ $single_payment_line->cheque_status }}<br>
                ...
                @if ($single_payment_line->method == 'cheque')
                <div class="col-xs-6">
                    <b>@lang('messages.Number_De_Jour'): </b>
                ...
                @if ($single_payment_line->method == 'cheque')
                <div class="col-xs-6">
                    <strong>@lang('messages.cheque_owner') :</strong>
                    {{ $single_payment_line->cheque_owner }}
                </div>
                @endif
                @if ($single_payment_line->method == 'cheque')
                <div class="col-xs-6">
                    <strong>@lang('messages.bank_name') :</strong>
                    {{ $single_payment_line->bank_name }}
                </div>
                @endif
