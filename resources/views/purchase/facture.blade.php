...
<section class="content-header no-print">
    <h1>@lang('purchase.purchases_fact')
        <small></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content no-print">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.all_purchases_fact')])
        @can('purchase.create')
            @slot('tool')
                <div class="box-tools">
            ...
            @endslot
        @endcan
        <table class="table table-bordered table-striped ajax_view" id="purchase_table1" style="width: 100%;">
            <thead>
                <tr>
