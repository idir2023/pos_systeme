    ...
    <div class="col-sm-3">
        <div class="form-group">
            <div class="checkbox">
                <label>
                    <br>
                    {!! Form::checkbox('only_facture', 1, $purchase->facture_numero ? true : false, ['class' => 'input-icheck', 'id' => 'only_facture']) !!} {{ __('messages.facture')}}
                </label>
            </div>
        </div>
    </div>

    <div class="col-sm-3 {{ $purchase->facture_numero ? '' : 'hide' }}" id="facture_numero_container">
        <div class="form-group">
            {!! Form::label('facture_numero', __('lang_v1.Facture_Numero') . ':') !!}
            {!! Form::text('facture_numero', $purchase->facture_numero, ['class' => 'form-control',
            'data-facture_numero' => $purchase->facture_numero,
