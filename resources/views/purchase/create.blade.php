...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
            <div class="form-group">
                ...
                isset($orderStatuses->status) ? $orderStatuses->status : 'received'
        ...
        <div class="col-sm-3 {{ session()->get('business.pay_term_number') == 0 ? 'hide' : '' }}">
            <div class="form-group">
        ...
        <div class="col-sm-3 {{ session()->get('business.document_purchase') == 0 ? 'hide' : '' }}">
            <div class="form-group">
    ...
    <div class="col-sm-3 hide" id="facture_numero_container">
        <div class="form-group">
            ...
            {!! Form::text('facture_numero', null, ['class' => 'form-control', 'placeholder' => __('lang_v1.Facture_Numero')]) !!}
        </div>
    </div>
    @endif
    {{-- --}}
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <div class="form-group">
                <button tabindex="-1" type="button" class="btn btn-link btn-modal" data-href="{{action([\App\Http\Controllers\ProductController::class, 'quickAdd'])}}" data-container=".quick_add_product_modal"><i class="fa fa-plus"></i> @lang( 'product.add_new_product' ) </button>
            </div>
        </div>
    </div>
    @php
                ...
                <table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
                    <thead>
                        <tr>
                            ...
                            <th class="{{ session()->get('business.discount_percent_purchase') == 0 ? 'hide' : '' }}">@lang( 'lang_v1.discount_percent' )</th>
                            <th class="{{ session()->get('business.unit_cost_before_tax') == 0 ? 'hide' : '' }}">@lang( 'purchase.unit_cost_before_tax' )</th>
                            ...
                            {{-- --}}
                            <th class="{{ session()->get('business.unit_selling_price') == 0 ? 'hide' : '' }}">
