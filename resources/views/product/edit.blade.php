...
<section class="content">
    ...
    <div class="row">
        ...
        <div id="sub_sub_category" class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
            <div class="form-group">
                ...
                {!! Form::select('sub_sub_category_id', $sub_sub_categories, $product->sub_sub_category_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
            </div>
        </div>
    ...
    @component('components.filters1', ['class' => 'box-primary'])
    <div class="row">
