        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('sub_category_id', $sub_categories, !empty($duplicate_product->sub_category_id) ? $duplicate_product->sub_category_id : null,
                    ['placeholder' => __('lang_v1.all'), 'class' => 'form-control select2', 'id'=>'product_list_filter_sub_category_id']); !!}
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('sub_sub_category_id', $sub_sub_categories, !empty($duplicate_product->sub_sub_category_id) ? $duplicate_product->sub_sub_category_id : null,
                    ['placeholder' => __('lang_v1.all'), 'id'=>'product_list_filter_sub_sub_category_id', 'class' => 'form-control select2']); !!}
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        product_table = $('#product_table').DataTable({
            ...
            , "ajax": {
                ...
                , "data": function(d) {
                    ...
                    d.sub_sub_category_id = $('#product_list_filter_sub_sub_category_id').val();
        ...
        $(document).on('change', '#product_list_filter_type,#product_list_filter_category_id,#product_list_filter_sub_category_id,#product_list_filter_sub_sub_category_id,#product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id'
            , function() {
