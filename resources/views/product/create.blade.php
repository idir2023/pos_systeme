...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!session('business.barcode_type')) hide @endif ">
            <div class="form-group">
        ...
        <div id="sub_category" class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
            <div class="form-group">
        ...
        <div id="sub_sub_category" class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
            <div class="form-group">
                {!! Form::label('sub_sub_category_id', __('product.sub_sub_category') . ':') !!}
                {!! Form::select('sub_sub_category_id', $sub_categories, !empty($duplicate_product->sub_category_id) ? $duplicate_product->sub_category_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
            </div>
        </div>
    ...
    @component('components.filters1', ['title'=>__('product.more_info'),'class' => 'box-primary'])
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!session('business.applicable_tax')) hide @endif @if(!session('business.enable_price_tax')) hide @endif">
            <div class="form-group">
        ...
        <div class="col-sm-4 @if(!session('business.selling_price_tax_type')) hide @endif  @if(!session('business.enable_price_tax')) hide @endif">
            <div class="form-group">
