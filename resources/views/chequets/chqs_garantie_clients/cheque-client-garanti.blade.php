@extends('layouts.app')
@section('title', __('lang_v1.customer_cheques'))
...
@section('content')
    ...
    <section class="content no-print">   
        ...
        <a class="btn btn-primary btn-sm pull-right" style="margin: 20px;" data-toggle="modal"
            href="{{ action([\App\Http\Controllers\ChqsClientController::class, 'create']) }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            chequeGarantiePaymentReport = $('table#chequeGarantie_payment_report_table').DataTable({
                ...
                ajax: {
                    url: '/chqs_client', // Make sure this URL is correct
            ...
            $('#chequeGarantie_payment_report_table').on('click', '.delete_cheque_garant', function(e) {
                swal({
                    title: 'Are you sure?',
