@extends('layouts.app')
@section('title', __('messages.management_supplier_checks'))

@section('content')
    <section class="content-header">
        <h1>@lang('messages.management_supplier_checks')</h1>
        <br>
    </section>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::label('supplier_id', __('role.supplier')) !!}
...
<script src="{{ asset('js/payment.js?v=' . $asset_v) }}"></script>
    <script>
        $(document).ready(function() {
            var chequeGarantiePaymentReport = $('table#cheque_payment_report_table').DataTable({
                processing: true,
                serverSide: false,
                aaSorting: [
                    [2, 'desc']
            ...
            $('#cheque_payment_report_table').on('click', '.delete_cheque', function(e) {
                swal({
                    title: 'Are you sure?',
            ...
            $(' #location_id,  #CustomerGroup_id,  #supplier_id, #cheque_type, #cheque_statut')
                .change(function() {
            ...
            function refreshTable() {
                chequeGarantiePaymentReport.ajax.reload(null, false);
            }
        });
    </script>
@endsection
