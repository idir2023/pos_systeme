...
<hr>
<div class='row'>
  <div class="col-md-12"><h4>@lang('Add Purchase') @show_tooltip(__('lang_v1.payment_link_help_text')):</h4></div>

    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('pay_term_number', 1, $business->pay_term_number, [ 'class' => 'input-icheck']); !!} {{ __('contact.pay_term')}}
              </label>
            </div>
        </div>
      </div>
      ...
      <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('document_purchase', 1, $business->document_purchase, [ 'class' => 'input-icheck']); !!} {{ __('purchase.attach_document') }}
              </label>
            </div>
        </div>
      </div>
...
<hr>
<div class='row'>
  <div class="col-md-12"><h4>@lang('Table Product') @show_tooltip(__('lang_v1.payment_link_help_text')):</h4></div>

    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('discount_percent_purchase', 1, $business->discount_percent_purchase, [ 'class' => 'input-icheck']); !!} {{ __('lang_v1.discount_percent')}}
              </label>
            </div>
        </div>
      </div>
      ...
      <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('unit_cost_before_tax', 1, $business->unit_cost_before_tax, [ 'class' => 'input-icheck']); !!} {{ __('purchase.unit_cost_before_tax') }}
              </label>
            </div>
        </div>
      </div>
{{--  --}}
      <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('unit_selling_price', 1, $business->unit_selling_price, [ 'class' => 'input-icheck']); !!} {{ __('purchase.unit_selling_price') }}
              </label>
            </div>
        </div>
      </div>
