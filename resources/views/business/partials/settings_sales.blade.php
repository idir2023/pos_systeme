<div class="pos-tab-content">
    ...
    <div class="radio">
        <label>
            <input type="radio" name="sell_price_tax" value="excludes" class="input-icheck" @if($business->sell_price_tax == 'excludes') {{'checked'}} @endif>Excludes the Sale Tax (Calculate sale tax on Selling Price provided in Add Purchase)
        </label>
    </div>
</div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('import_sales', 1, $business->import_sales, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.import_sales' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('discounts', 1, $business->discounts, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.discounts' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('shipments', 1, $business->shipments, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.shipments' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('add_draft', 1, $business->add_draft, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.add_draft' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('list_drafts', 1, $business->list_drafts, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.list_drafts' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('add_quotation', 1, $business->add_quotation, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.add_quotation' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('list_quotations', 1, $business->list_quotations, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.list_quotations' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class="col-sm-4">
    <div class="form-group">
        <div class="checkbox">
            <label>
                {!! Form::checkbox('facture', 1, $business->facture, [ 'class' => 'input-icheck']); !!} {{ __( 'messages.facture' ) }}
            </label>
        </div>
    </div>
</div>
...
<div class='row'>
    ...
    <div class="col-md-12">
        <h4>@lang('Add Sell') @show_tooltip(__('lang_v1.payment_link_help_text')):</h4>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('pay_term', 1, $business->pay_term, [ 'class' => 'input-icheck']); !!} {{ __('contact.pay_term')}}
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('invoice_scheme_id', 1, $business->invoice_scheme_id, [ 'class' => 'input-icheck']); !!} {{ __( 'invoice.invoice_scheme' ) }}
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('sell_document', 1, $business->sell_document, [ 'class' => 'input-icheck']); !!} {{ __('purchase.attach_document') }}
                </label>
            </div>
        </div>
    </div>
