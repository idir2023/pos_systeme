        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    {!! Form::text('invoice_no', null, ['class' => 'form-control', 'placeholder' => $sale_type == 'sales_order' ? __('restaurant.order_no') : ($status == 'quotation' ? __('sale.devis_no') : __('sale.invoice_no'))]) !!}
