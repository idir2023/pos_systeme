...
<section class="content no-print">
        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                <div class="form-group">
                    ...
                    <small class="text-danger hide contact_due_text"><strong>@lang('account.customer_due_balance'):</strong> <span></span></small> <br>
                    <small class="hide contact_garantue_text"><strong>@lang('account.Garantie'):</strong> <span></span></small> <br>
                    {{-- --}}
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {!! Form::select('commission_agent', $commission_agent, null, ['class' => 'form-control select2', 'id' => 'commission_agent', 'required' => $is_commission_agent_required]); !!}
                </div>
            </div>
            @endif
            <div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    {!! Form::label('invoice_no', $sale_type == 'sales_order' ? __('restaurant.order_no') : ($status == 'quotation' ? __('sale.devis_no') : __('sale.invoice_no')) . ':') !!}
                    {!! Form::text('invoice_no', null, ['class' => 'form-control invoice_no', 'placeholder' => $sale_type == 'sales_order' ? __('restaurant.order_no') : ($status == 'quotation' ? __('sale.devis_no') : __('sale.invoice_no'))]) !!}
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <br>
                            {!! Form::checkbox('only_facture', 1, false, ['class' => 'input-icheck', 'id' => 'only_facture']) !!} {{ __('messages.facture')}}
                        </label>
                    </div>
                </div>
            </div>

            <div class="col-sm-3 hide" id="facture_numero_container">
                <div class="form-group">
    ...
    @for($i; $i <= 6 ; $i++) <div class="col-md-4 export_div" @if(empty($walk_in_customer['is_export'])) style="display: none;" @endif>
        ...
        <div class="payment_row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text("change", @num_format($payment_line['amount']), ['class' => 'form-control input_number1', 'required', 'placeholder' => __('sale.amount'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            @php
                            $_payment_method = empty($change_return['method']) && array_key_exists('advance', $payment_types) ? 'advance' : $change_return['method'];
                            $_payment_types = $payment_types;
                            @endphp
                            {!! Form::select("payment[change][method]", $_payment_types, $_payment_method, ['class' => 'form-control col-md-12 payment_types_dropdown1', 'style' => 'width:100%;','readonly']); !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right"><strong>@lang('lang_v1.balance'):</strong> <span id="balance_due" class="balance_due">0.00</span></div>
