...
<section class="content no-print">
    ...
    {!! Form::open(['url' => action([\App\Http\Controllers\SellPosController::class, 'store']), 'method' => 'post', 'id'
    => 'add_sell_form', 'files' => true ]) !!}
    @if(!empty($sale_type))
        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        array_key_exists($default_price_group_id, $price_groups) ? $default_price_group_id : null;
                        @endphp
                        {!! Form::hidden('hidden_price_group', key($price_groups), ['id' => 'hidden_price_group']) !!}
                        {!! Form::select('price_group', $price_groups, $selected_price_group, ['class' => 'form-control
                        select2', 'id' => 'price_group']); !!}
                        <span class="input-group-addon">
            ...
            <div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                <div class="form-group">
                    ...
                    <small
                        class="text-danger hide contact_due_text"><strong>@lang('account.customer_due_balance'):</strong>
                        <span></span></small> <br>
                    <small class="hide contact_garantue_text"><strong>@lang('account.Garantie'):</strong>
                        <span></span></small> <br>
                    {{-- --}}
                    <input type="hidden" id='contact_due_input' name="contact_due" value="">
            ...
            <div class="col-sm-3 {{ session()->get('business.pay_term') == 0 ? 'hide' : '' }}">
                <div class="form-group">
                    <div class="multi-input">
                        ...
                        'form-control width-40 pull-left', 'placeholder' => __('contact.pay_term'), 'required' =>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    'id' => 'commission_agent', 'required' => $is_commission_agent_required]); !!}
                </div>
            </div>
            @endif
            <div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
            ...
            <div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                <div class="form-group">
                    ...
                    isset($statuses->status) ? $statuses->status : 'final',
            ...
            @if($sale_type != 'sales_order')
            <div class="col-sm-3 {{ session()->get('business.invoice_scheme_id') == 0 ? 'hide' : '' }}">
                <div class="form-group">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    {!! Form::label('invoice_no', $sale_type == 'sales_order' ? __('restaurant.order_no') : ($status ==
                    'quotation' ? __('sale.devis_no') : __('sale.invoice_no')) . ':') !!}
                    {!! Form::text('invoice_no', null, ['class' => 'form-control invoice_no', 'placeholder' =>
                    $sale_type == 'sales_order' ? __('restaurant.order_no') : ($status == 'quotation' ?
                    __('sale.devis_no') : __('sale.invoice_no'))]) !!}
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <br>
                            {!! Form::checkbox('only_facture', 1, true, ['class' => 'input-icheck', 'id' =>
                            'only_facture']) !!} {{ __('messages.facture')}}
                        </label>
                    </div>
                </div>
            </div>

            <div class="col-sm-3 " id="facture_numero_container">
                <div class="form-group">
                    {!! Form::label('facture_numero', __('lang_v1.Facture_Numero') . ':') !!}
                    {!! Form::text('facture_numero', ($transactionMax + 1), ['class' => 'form-control',
                    'data-facture_numero' => ($transactionMax + 1),
                    'id'=>'facture_numero', 'placeholder' => __('lang_v1.Facture_Numero')]) !!}
                </div>
            </div>
            @endif
            @endif
            ...
            <div class="col-md-3 {{ session()->get('business.sell_document') == 0 ? 'hide' : '' }}">
                <div class="form-group">
            ...
            @component('components.filters1', ['title' => __('Remise')])
            ...
            @component('components.filters2', ['title' => __('Expédition')])
            <div class="col-md-4">
                <div class="form-group">
                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {!! Form::text('additional_expense_value_1', 0, ['class' => 'form-control input_number',
                        ...
                        <tr>
                            ...
                            <td>
                                {!! Form::text('additional_expense_value_2', 0, ['class' => 'form-control input_number',
                        ...
                        <tr>
                            ...
                            <td>
                                {!! Form::text('additional_expense_value_3', 0, ['class' => 'form-control input_number',
                        ...
                        <tr>
                            ...
                            <td>
                                {!! Form::text('additional_expense_value_4', 0, ['class' => 'form-control input_number',
    ...
    @for($i; $i <= 6 ; $i++) <div class="col-md-4 export_div" @if(empty($walk_in_customer['is_export']))
        ...
        <div class="payment_row" @if($is_enabled_download_pdf) id="payment_rows_div" @endif>
            ...
            @include('sale_pos.partials.payment_row_form', ['row_index' => 0, 'show_date' => true, 'show_denomination'
            => true])
        </div>
        <hr>
        <div class="payment_row">
            {{-- --}}
            <div class="row hide payment_row" id="change_payment_data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text("change", @num_format($payment_line['amount']), ['class' => 'form-control
                            input_number1', 'required', 'placeholder' => __('sale.amount'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            @format_datetime($payment_line['paid_on']) : @format_datetime('now'), ['class' =>
                            'form-control paid_on', 'readonly', 'required']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label("change_return_method" , __('lang_v1.payment_method') . ':*') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fas fa-money-bill-alt"></i>
                            </span>
                            @php
                            $_payment_method = empty($change_return['method']) && array_key_exists('advance',
                            $payment_types) ? 'advance' : $change_return['method'];
                            $_payment_types = $payment_types;
                            @endphp
                            {!! Form::select("payment[change][method]", $_payment_types, $_payment_method, ['class' =>
                            'form-control col-md-12 payment_types_dropdown1', 'style' => 'width:100%;','readonly']); !!}
                        </div>
                    </div>
                </div>

                <div class="col-md-12">
                    <button type="button" class="btn btn-danger cancel-payment-row">@lang('messages.cancel')</button>
                </div>
            </div>
            {{-- --}}
            <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::hidden("change_return", $change_return['amount'], ['class' => 'form-control change_return
                    input_number', 'required', 'id' => "change_return"]); !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            @php
                            $_payment_method = empty($change_return['method']) && array_key_exists('cash',
                            $payment_types) ? 'cash' : $change_return['method'];
                            ...
                            ['class' => 'form-control col-md-12 payment_types_dropdown', 'id' => 'change_return_method',
                            'style' => 'width:100%;']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select("payment[change_return][account_id]", $accounts,
                            !empty($change_return['account_id']) ? $change_return['account_id'] : '' , ['class' =>
                            'form-control select2', 'id' => 'change_return_account', 'style' => 'width:100%;']); !!}
                        </div>
                    </div>
                </div>
                @endif
                @include('sale_pos.partials.payment_type_details', ['payment_line' => $change_return, 'row_index' =>
                'change_return'])
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right"><strong>@lang('lang_v1.balance'):</strong> <span id="balance_due"
                            class="balance_due">0.00</span></div>
                    <input type="hidden" id="in_balance_due" name='equilibre' value=0>
                </div>
            </div>
        </div>
        @endif
