<div class="box @if(!empty($class)) {{$class}} @else box-solid @endif" id="accordion">
  <div class="box-header with-border" style="cursor: pointer;">
      <h3 class="box-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapseFilter1">
  ...
  <div id="collapseFilter1" class="panel-collapse active collapse @if($closed) @else in @endif" aria-expanded="true">
      <div class="box-body">
          {{$slot}}
      </div>
  </div>
