	...
	<div  style="text-align: center;">
	  <div class="row" style="color: #000000 !important;">
		@if(empty($receipt_details->letter_head))
			...
			<!-- business information here -->
			<div class="col-xs-8" style="margin-top: 37px !important;" >
...
<table class="table table-responsive table-slim col-xs-12">
	<thead>
     <tr>
			...
			<tbody  class="tdStyle" >
				@forelse($receipt_details->lines as $line)
					<tr>
						...
						<td class="text-right" style="text-align: center;" >{{$line['line_total']}}</td>
					</tr>
...
<div class="row" style="color: #000000 !important;page-break-inside: avoid;" >
	<div class="col-md-12"><hr/></div>
	<div class="col-xs-7">

		<table class="table table-slim total_style " style="">
            ...
            @if(!empty($receipt_details->total_in_words))
        		<div class="col-xs-12">
        			<h5>
        				...
        				{{ucfirst($receipt_details->total_in_words)}} dirhams.
        			</h5>
        		</div>							
        	@endif
	        </td>
...
<div class="page-footer">
	<div  style="text-align: center;">
		FAOUZI FROID Sarl: Froid - Climatisation - Ventilation | Patente:35503353 | Adresse: N°375 Quartier Awatif El Kelaa des Sraghna | Tél: +212646187574 | E-mail: arqanevision@gmail.com
    </div>
</div>
