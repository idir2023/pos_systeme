...
<div class="row" style="color: #000000 !important;">
	@if(empty($receipt_details->letter_head))
		...
		<div class="col-xs-4">
			<img style="max-height: 150px; width: auto;" src="{{$receipt_details->logo}}" class="img img-responsive">
		</div>	
		@endif
		<!-- Header text -->
		...
		<table class="table table-responsive table-slim" >
			<thead class="thStyle">
				<tr >
    				...
    				@else
    					<th  class="text-left" width="10%">ثمن الوحدة</th>
    					<th  class="text-left" width="20%">الجموع</th>
					@endif
				</tr>
			</thead>
			<tbody  class="tdStyle" >
...
<div class="page-footer">
	<div  style="text-align: center;">
		FAOUZI FROID Sarl: Froid - Climatisation - Ventilation | Patente:35503353 | Adresse: N°375 Quartier Awatif El Kelaa des Sraghna | Tél: +212661500760 - +212652265105 - +212708607410 
    </div>
</div>
