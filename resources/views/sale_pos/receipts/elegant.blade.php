...
<table class="tablePrint" style="width:100%; color: #000000 !important; ">
	<thead>
		<tr>
			<td>
				<p class="text-right">
	...
	<tbody style="min-height: 340px !important;">
				...
				<div class="row invoice-info">
					...
					<div class="col-md-6 invoice-col width-50 ">
						...
						@if(!empty($receipt_details->logo))
							...
							<br/>
						@endif
                        <div class="word-wrap" style="background-color: #f1ebeb  !important;">
				...
				<div class="row  mt-5">
					<div class="col-xs-12">
						<table class="table table-bordered table-no-top-cell-border table-slim mb-12">
							<thead>
								<tr style="background-color:gray !important; color: white !important; font-size: 20px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
									<td style="background-color: gray !important; color: white !important; width: 5% !important">#</td>
									...
									@if(!empty($receipt_details->discounted_unit_price_label))
										...
										@endphp
									@endif
									<td style="background-color: gray !important; color: white !important; width: {{$p_width}}% !important">
										{{$receipt_details->table_product_label}}
									</td>

									@if($receipt_details->show_cat_code == 1)
										<td style="background-color: gray !important; color: white !important; width: 10% !important;">{{$receipt_details->cat_code_label}}</td>
									@endif
									
									<td style="background-color: gray !important; color: white !important; width: 15% !important;">
									...
									@if(!empty($receipt_details->discounted_unit_price_label))
									<td style="background-color: gray !important; color: white !important; width: 10% !important;">
						...
						<table class="table table-slim">
							@if(!empty($receipt_details->payments))
								@foreach($receipt_details->payments as $payment)
									<tr >
										<td style="background-color: #f1ebeb !important;">{{$payment['method']}}</td>
										<td style="background-color: #f1ebeb !important;">{{$payment['amount']}}</td>
										<td style="background-color: #f1ebeb !important;">{{$payment['date']}}</td>
									</tr>
								@endforeach
							@endif
						</table>
					...
					<div class="col-md-6 invoice-col width-50">
						<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
							<tbody>
								...
								@endif
								<tr >
									<td style="width:50% ;background-color: #f1ebeb !important;">
										{!! $receipt_details->subtotal_label !!}
									</td>
									<td class="text-right" style="width:50% ;background-color: #f1ebeb !important;" >
								...
								<!-- Total -->
								<tr>
									<th style="background-color: gray !important; color: white !important" class="font-20 padding-8">
										{!! $receipt_details->total_label !!}
									</th>
									<td class="text-right font-18 padding-10" style="background-color: gray !important; color: white !important">
