...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-12 text-center">
		...
		<p style="width: 100% !important" class="word-wrap">
			<span class="pull-right text-left word-wrap" style="margin-right: 38px;font-size:20px">
				...
				@if(!empty($receipt_details->customer_info))
					<br/>
					<b style="background-color: white; !important; color: #535353 !important; font-size: 20px !important">Information {{ $receipt_details->customer_label }}</b> <br> {!! $receipt_details->customer_info !!} <br>
				@endif
			...
			<span class="pull-left text-left" style="font-size:20px!important; margin-left: 10px;">
...
<div class="page-footer">
	...
	<div  style="text-align: center;">
		FRUITAS - Siège social : 325 , route de Toulon 83400 Hyères France - Tél: +33761461715 
RCS n° : 839 356 474 R.C.S.Toulon - Capital de 200 € - Email: sas.fruitas@gmail.com
    </div>
