...
{{-- @if(session()->get('business.enable_modal_pos') == 1 )
<div class="modal fade row_product_price_model" id="row_product_price_modal_{{$row_count}}" tabindex="-1" role="dialog">
	@include('sale_pos.partials.row_product_price_modal')
</div>
@endif --}}
