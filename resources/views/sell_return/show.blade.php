    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.sell_return') (<b>@lang('sale.invoice_no'):</b>
                {{ $sell->return_parent->invoice_no ?: $sell->invoice_no }})
            </h4>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-6 col-xs-6">
                    ...
                    {{ @format_date($sell->return_parent->transaction_date ?: $sell->transaction_date) }}<br>
                ...
                <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><b>(-)</b></td>
                            <td class="text-right">
                                @if ($sell->return_parent->discount_type ?: $sell->discount_type == 'percentage')
                                    @
                                    <strong><small>{{ $sell->return_parent->discount_amount ?: $sell->discount_amount }}%</small></strong>
                                    -
                                @endif
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td><span class="display_currency pull-right"
                                    data-currency_symbol="true">{{ $sell->return_parent->final_total ?: $sell->final_total }}</span>
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="modal-footer">
            <a href="#" class="print-invoice btn btn-primary"
                data-href="{{ action([\App\Http\Controllers\SellReturnController::class, 'printInvoice'], [$sell->return_parent->id ?: $sell->id]) }}"><i
