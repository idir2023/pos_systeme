            ...
            return Datatables::of($productions)
                ...
                ->editColumn('ref_no', function ($row) use ($request) {
                    ...
                    $ref_nos_str = implode('<br>', array_map(function ($ref_no, $qty, $unit, $id) {
                        return '<a data-href="' . action([\Modules\Manufacturing\Http\Controllers\ProductionController::class, 'show'], $id) . '" class="btn-modal" data-container=".view_modal">' . $ref_no . ' (<span style="color: blue;">' . $this->productUtil->num_f($qty) . $unit . '</span>' . ')</a>';
                ...
                ->rawColumns(['final_total', 'ref_no', 'total_quantity', 'product_name'])
            ...
            return Datatables::of($productions)
                ...
                ->editColumn('ref_no', function ($row) use ($request) {
                    ...
                    if ($production->isNotEmpty()) {
                        ...
                        // Création de la chaîne de ref_nos formatée
                        $ref_nos_str = implode('<br>', array_map(function ($ref_no, $qty, $unit, $id) {
                            return '<a data-href="' . action([\Modules\Manufacturing\Http\Controllers\ProductionController::class, 'show'], $id) . '" class="btn-modal" data-container=".view_modal">' . $ref_no . ' (<span style="color: red;">' . $this->productUtil->num_f($qty) . $unit . '</span>' . ')</a>';
                        }, $ref_nos, $qty, $unit, $ids));
                    }
