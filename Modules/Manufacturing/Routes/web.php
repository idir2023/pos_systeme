...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('manufacturing')->group(function () {
    ...
    Route::get('/getRaportProduction', [Modules\Manufacturing\Http\Controllers\ProductionController::class, 'getRaportProduction']);
    
    Route::get('/getRaportIngredient', [Modules\Manufacturing\Http\Controllers\ProductionController::class, 'getRaportIngredient']);
