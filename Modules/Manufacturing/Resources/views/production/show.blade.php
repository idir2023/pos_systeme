                ...
                <div class="col-md-12">
                    <table class="table">
                        ...
                        <tfoot>
                            ...
                            <tr><td colspan="4" class="text-right"><strong>
                                Coût par unité produite:</strong></td>
                                <td><span class="display_currency" data-currency_symbol="true">{{$production_purchase->final_total/$quantity}}</span></td></tr>    
                        </tfoot>
                    </table>
                </div>
            </div>
