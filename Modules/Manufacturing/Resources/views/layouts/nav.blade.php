            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @can('manufacturing.access_production')
                        ...
                        <li @if(request()->segment(2) == 'getRaportProduction') class="active" @endif><a href="{{action([\Modules\Manufacturing\Http\Controllers\ProductionController::class, 'getRaportProduction'])}}">Rapport de Production</a></li>

                        <li @if(request()->segment(2) == 'getRaportIngredient') class="active" @endif><a href="{{action([\Modules\Manufacturing\Http\Controllers\ProductionController::class, 'getRaportIngredient'])}}">Rapport d'Ingrédients</a></li>
