            ...
            return Datatables::of($productions)
                ...
                ->editColumn('ref_no', function ($row) use ($request) {
                    ...
                    if ($request->has('category_id')) {
                        ...
                        if ($categoryId) {
                            $productionQuery->whereHas('purchase_lines.variations.product', function ($query) use ($categoryId) {
                ...
                ->editColumn('current_stock', function ($row) use ($request) {
                    ...
                    // return '<span class="display_currency" data-is_quantity="true">' . $current_stock->qty_available . ' ' . $current_stock->unit . '</span>';
