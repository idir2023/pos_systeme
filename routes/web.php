...
use App\Http\Controllers\ChqsClientController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/get-contact-due-balance/{contact_id}', [ContactController::class, 'getContactDueBalance']);
    ...
    Route::post('/products/get_sub_sub_categories', [ProductController::class, 'getSubSubCategories']);
    ...
    Route::get('/sells/create_facture', [SellController::class, 'create_facture']);
    Route::get('/sells/facture', [SellController::class, 'getFacture']);
    Route::get('/sells/getfacture/{id}', [SellController::class, 'getModalFacture'])->name('sells.getfacture'); // Added route for displaying the modal
    Route::put('/sells/postfacture/{id}', [SellController::class, 'PostFacture'])->name('sells.postfacture');    

    // convert to bbl and fc

    Route::get('/sells/convert-bbl/{id}', [SellController::class, 'convertBbl']);
    Route::get('/sells/convert-fc/{id}', [SellController::class, 'convertFc']);
    ...
    Route::get('/purchases/facture', [PurchaseController::class, 'getFacture']);
    Route::get('/purchases/getfacture/{id}', [PurchaseController::class, 'getModalFacture'])->name('purchases.getfacture'); // Added route for displaying the modal
    Route::put('/purchases/postfacture/{id}', [PurchaseController::class, 'PostFacture'])->name('purchases.postfacture');    
    ...
    //Cheques schemes..
    Route::resource('chqs_client' , ChqsClientController::class);
    Route::resource('chqs_fournisseur' , ChqsFournisseurController::class);
    Route::resource('cheque_fournisseur' , ChequeFournisseurController::class);
    Route::resource('cheque_client' , ChequeClientController::class);
    Route::resource('cheque_depense' , ChequeDepenseController::class);
    ...
    Route::post('/reports/postPaymentReport', [ReportController::class, 'postPaymentReport']);
    ...
    // start
    Route::get('/payments/pay-contact-due-check/{contact_id}', [TransactionPaymentController::class, 'getPayContactDueCheck']);
    // end
    ...
    Route::get('/getTransfert/{contact_id}', [TransactionPaymentController::class, 'getTransfert']);
    Route::get('cheque/edit/{id}', [TransactionPaymentController::class, 'edit2']);
    Route::get('cheque/editClient/{id}', [TransactionPaymentController::class, 'edit3']);

    Route::put('cheque/update/{id}', [TransactionPaymentController::class, 'updateChequeParent']);
    Route::put('cheque/updateClient/{id}', [TransactionPaymentController::class, 'updateChequeParentClient']);

    //
    Route::get('/showbefordelete/{id}', [TransactionPaymentController::class, 'showbefordelete']);
    ...
    Route::post('sell-return/get-product-row', [CombinedPurchaseReturnController::class, 'getSellProductRow']);
    ...
    // 
    Route::get('/get-sell-return', [SellReturnController::class, 'getSellReturn']);
    Route::get('/get-sell-return/create', [SellReturnController::class, 'create']);
    Route::post('/get-sell-return/save', [SellReturnController::class, 'save']);
    // 
    ...
    Route::get('getChequeClient', [HomeController::class, 'getChequeClient']);
    Route::get('getChequeFournisseur', [HomeController::class, 'getChequeFournisseur']);
    Route::get('getChequeDeponse', [HomeController::class, 'getChequeDeponse']);
});
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/sells/invoice-show/{id}', [SellPosController::class, 'showInvoiceModal']);
