<?php
 ...
 return [
     'product_stock_alert' => "Articles à faible stock. <br/> <small class = 'text-muted'> Basé sur la quantité d'alerte d article définie dans l'écran d'ajout d article. <br> Achetez ce Article avant la fin du stock. </small>",
     ...
     'no_of_products_for_trending_products' => 'Nombre d articles de tendance à comparer dans le tableau ci-dessous.',
     ...
     'sku' => "Identifiant d article unique ou unité de gestion des stocks <br> <br> laissez-le vide pour générer automatiquement sku. <br> <small class = 'text-muted'> Vous pouvez modifier le préfixe sku dans les paramètres métier </small> ",
     'enable_stock' => 'Activer ou désactiver la gestion des stocks pour un Article.',
     'alert_quantity' => "Soyez alerté lorsque le stock d articles atteint ou descend en dessous de la quantité spécifiée. <br> <br> <small class = 'text-muted'> Les Articles avec un stock faible s'afficheront dans le tableau de bord - Section Alerte stock Article. </small>",
     ...
     'purchase_location' => "dépôt de l'entreprise où le Article acheté sera disponible à la vente.",
     'sale_location' => "dépôt d'affaires d'où vous voulez vendre",
     ...
     'invoice_scheme' => "Schéma de facture signifie le format de numérotation des factures.Sélectionnez le schéma à utiliser pour cet dépôt d'entreprise <br> <small class = 'text-muted'> <i> Vous pouvez ajouter un nouveau schéma de facture </b> dans les paramètres de facture </ i > </small> ",
     ...
     'access_locations_permission' => "Choisissez tous les dépôts auxquels ce rôle peut accéder.Toutes les données de le dépôt sélectionné ne seront affichées qu'à l'utilisateur. <br/> <br/> <small> Par exemple: Vous pouvez utiliser ceci pour définir <i> Gérant de magasin / Caissier / Gestionnaire de stock / Gestionnaire de succursale, </i> d'Dépôt particulier. </small> ",
