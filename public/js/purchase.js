...
//   
    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        aaSorting: [[1, 'desc']],
        buttons: [
            { extend: 'copy', text: '<i class="fas fa-copy fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-copy buttons-html5 btn-sm', titleAttr: 'Copy data grid to clipboard' },
            ...
            { extend: 'print', text: '<i class="fas fa-print fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-print btn-sm', titleAttr: 'Print data grid' },
            { 
                extend: 'colvis', 
        ...
        columns: [
            ...
            { data: 'location_name', name: 'BS.name', visible: true},
    ...
    //
    purchase_table1 = $('#purchase_table1').DataTable({
        processing: true,
        serverSide: true,
        scrollY: "75vh",
        scrollX:        true,
        ...
        buttons: [
            { extend: 'copy', text: '<i class="fas fa-copy fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-copy buttons-html5 btn-sm', titleAttr: 'Copy data grid to clipboard' },
            { extend: 'csv', text: '<i class="fas fa-file-csv fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-csv buttons-html5 btn-sm', titleAttr: 'Copy data grid to a CSV file' },
            { extend: 'excel', text: '<i class="fas fa-file-excel fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-excel buttons-html5 btn-sm', titleAttr: 'Copy data grid to a Excel file' },
            { extend: 'pdf', text: '<i class="fas fa-file-pdf fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-pdf buttons-html5 btn-sm', titleAttr: 'Copy data grid to a PDF file' },
            { extend: 'print', text: '<i class="fas fa-print fa-2x" style="color: orange;"></i>', className: 'btn btn-default buttons-print btn-sm', titleAttr: 'Print data grid' },
            { 
                extend: 'colvis', 
                text: '<i class="fas fa-eye fa-2x" style="color: orange;"></i>', 
        ...
        fnDrawCallback: function(oSettings) {
            __currency_convert_recursively($('#purchase_table1'));
        },
        "footerCallback": function ( row, data, start, end, display ) {
            var total_purchase = 0;
            var total_due = 0;
