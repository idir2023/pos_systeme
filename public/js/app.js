$(document).ready(function() {
    ...
    expense_table = $('#expense_table').DataTable({
        ...
        columns: [
            ...
            { data: 'recur_details', name: 'recur_details', orderable: false, searchable: false,visible:false },
            { data: 'category', name: 'ec.name' },
            { data: 'sub_category', name: 'esc.name',visible:false },
            { data: 'location_name', name: 'bl.name' },
            { data: 'payment_status', name: 'payment_status', orderable: false },
            { data: 'tax', name: 'tr.name',visible:false },
            { data: 'final_total', name: 'final_total' },
            { data: 'payment_due', name: 'payment_due' },
            { data: 'expense_for', name: 'expense_for',visible:false },
...
$(document).ready(function() {
    ...
    $('.sidebar-toggle').click(function() {
        // Toggle a class on the .sidebar-menu to indicate the sidebar state
        $('.sidebar-menu').toggleClass('sidebar-closed');
        
        // Check if the sidebar is closed or not
        if ($('.sidebar-menu').hasClass('sidebar-closed')) {
            // If the sidebar is closed, reduce the width and height of .fa icons
            $('.sidebar-menu>li>a>.fa').css({'font-size': '20px'});
        } else {
            // If the sidebar is open, revert the width and height of .fa icons
            $('.sidebar-menu>li>a>.fa').css({'font-size': '35px'});
        }
    });
});